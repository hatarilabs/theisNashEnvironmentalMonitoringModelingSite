...
\title{\textbf{HEC-RAS 2D Dynamic River Calibration}}
...
This document deals with the calibration of a HecRas 2D model over a period of increasing/decreasing flow with a time series of observed water stages. The only calibration parameter for this exercise is the n Manning

\section{Part 1: Setting up the model}
We have to configure the model to apply n Manning, observed data and other steps.

\subsection{Copy HEC-RAS Model} 
Open the saved Hec Ras model: 
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure1.png}
\caption{Open the HEC RAS Model}
%\label{fig:sample1}
\end{figure}

Create a HecCalibration folder and store the project as theisNash2

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure2.png}
\caption{Store the model as theisNash2}
%\label{fig:sample1}
\end{figure}

\subsection{Add Manning value} 

Open the Ras Mapper tool and turn on the edit mode on the River_Base geometry. 

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure3.png}
\caption{Edit the geometry}
%\label{fig:sample1}
\end{figure}

On 2D Flow Areas / Perimeters select Edit 2D Area Properties.

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure4.png}
\caption{Edit the geometry}
%\label{fig:sample1}
\end{figure}

The default value of n Manning will be 0.035. We havent change anything else so we close the window. Turn of the edit mode as well. 

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure5.png}
\caption{Assign the n value}
%\label{fig:sample1}
\end{figure}

\subsection{Import observation point locations} 

We will import the observation points from a shapefile. On Map Layers we add a reference layer.

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure6.png}
\caption{Add a reference layer}
%\label{fig:sample1}
\end{figure}

Select the Piezometers.shp from the Shp folder. Change the style to improve visibility.

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure7.png}
\caption{Import and style the observation points}
%\label{fig:sample1}
\end{figure}

Now we have to create a profile line where the observation location is located. Turn off editing.

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure8.png}
\caption{Create a profile line}
%\label{fig:sample1}
\end{figure}

Save your edits, close Ras Mapper. On Unsteady Flow Analysis 


\section{Part 1: Plan configuration}

\subsection{Get and apply the initial conditions}

We will run the simulation in order to get a surface to be used as initial condition. 

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure9.png}
\caption{Simulation with of the previous settings}
%\label{fig:sample1}
\end{figure}

Identify the .rst file. Copy and place it into the RST folder of the project

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure10.png}
\caption{Copy and paste the file with the initial conditions}
%\label{fig:sample1}
\end{figure}

Now we have to import these initial condition. On Unsteady Flow Data we have to import the Rst file. 

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure11.png}
\caption{Import the initial condition file}
%\label{fig:sample1}
\end{figure}

Important, save your Unsteady Flow Data.

\subsection{Define the simulation} 

The model will run for 4 days from the 16 Feb to 19 Feb 2024. On Unsteady Flow Analysis place the following:

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{Jpg/Calibration/Figure12.png}
\caption{Apply the new starting and ending data together with mapping interval}
%\label{fig:sample1}
\end{figure}

We are not going to simulate now. On Options select Automated Roughness Calibration.
...
------------
On rasmapper, edit geometry. Import the shapefile RiverChannel2023filled 

Edit off.  Save geometry

Import the geometry again. (calibration region dont appear)




, close Ras Mapper. On Unsteady Flow Analysis 
